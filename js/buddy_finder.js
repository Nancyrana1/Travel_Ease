...
var tbffirebase = {
  ...
  function startbasicfunctions() {
    ...
    greetuser.innerText = " Hello , " + nameofuserdisplay + " 🤗 " + "Welcome Back ! " + " ❤";
    ...
    usersRef.once('value', function (snapshot) {
        snapshot.forEach(function (childSnapshot) {
            ...
            if (
                ...
                alert("Your Personality Saved Successfuly In Your Account ☢ . Kindly Reload To See The Changes In Your Account In Account Section 😊")
